...
#ifndef VRS_WTRNOISE_ACTORS_REGISTRY_H
#define VRS_WTRNOISE_ACTORS_REGISTRY_H

#include "export.h"

#include "ActorWTRNOISEDLLInit.h"

#include <dtDAL/actorpluginregistry.h>

class VRS_WTRNOISE_EXPORT WTRNOISEActorsRegistry : public dtDAL::ActorPluginRegistry
{
   public:
		
		static dtCore::RefPtr<dtDAL::ActorType> WTRNOISEDLLINIT_ACTOR_TYPE;

      // Constructs our registry.  Creates the actor types easy access when needed.
      WTRNOISEActorsRegistry();

      // Registers actor types with the actor factory in the super class.
      virtual void RegisterActorTypes();
};
#endif //VRS_WTRNOISE_ACTORS_REGISTRY_H