...
public:
    ...
    /**
     * @fn  virtual void TestDirector2::OnMessage(const trManager::MessageBase& msg);
     *
    ...
    /**
     * @fn  virtual void TestDirector2::OnTick(const trManager::MessageBase& msg);
     *
    ...
    /**
     * @fn  virtual void TestDirector2::OnAddedToSysMan() override;
     *
...
protected:
    ...
    /**
     * @fn  virtual void TestDirector2::HandleTickMessage(const trManager::MessageBase& msg);
     *
