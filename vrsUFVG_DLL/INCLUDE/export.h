...
#ifndef VRSUFVGDLL_EXPORT_H
#define VRSUFVGDLL_EXPORT_H


#if defined(_MSC_VER) || defined(__CYGWIN__) || defined(__MINGW32__) || defined( __BCPLUSPLUS__)  || defined( __MWERKS__)
#  ifdef VRS_UFVG_LIBRARY
#    define VRS_UFVG_EXPORT __declspec(dllexport)
#  else
#    define VRS_UFVG_EXPORT __declspec(dllimport)
#  endif
#else
#  define VRS_UFVG_EXPORT
#endif


#endif //VRSUFVGDLL_EXPORT_H