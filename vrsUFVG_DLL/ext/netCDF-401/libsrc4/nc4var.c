...
$Id: nc4var.c,v 1.98 2009/03/20 18:04:08 ed Exp $
*/
...
nc_def_var_extra(int ncid, int varid, int *shuffle, int *deflate, int *deflate_level, 
                 int *fletcher32, int contiguous, size_t *chunksizes, int *no_fill, 
...
*/
int
nc_def_var_chunking(int ncid, int varid, int contiguous, size_t *chunksizesp)
{
