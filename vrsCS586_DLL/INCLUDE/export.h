...
#ifndef VRSCS586DLL_EXPORT_H
#define VRSCS586DLL_EXPORT_H


#if defined(_MSC_VER) || defined(__CYGWIN__) || defined(__MINGW32__) || defined( __BCPLUSPLUS__)  || defined( __MWERKS__)
#  ifdef VRS_CS586_LIBRARY
#    define VRS_CS586_EXPORT __declspec(dllexport)
#  else
#    define VRS_CS586_EXPORT __declspec(dllimport)
#  endif
#else
#  define VRS_CS586_EXPORT
#endif


#endif //VRSCS586DLL_EXPORT_H