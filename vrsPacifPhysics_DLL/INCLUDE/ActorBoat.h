...
#include "../../dtOcean/include/dtOcean/oceanactor.h"
#include "../../dtOcean/include/dtOcean/actorregistry.h"
...
class VRS_PACIFPHYSICS_EXPORT ActorBoat : public vrsCore::GameStaticMeshActor
{
	public:
		...
		ActorBoat(vrsCore::GameStaticMeshActorProxy& proxy);
		...
		*/
		...
		// Physics Stuff
		void SetUpPhysics();
		void CreateCornerPhysObjs();//(dtPhysics::PhysicsObject *physObj, osg::Vec3 pos);
		void BeforePhys();
		void AfterPhys();
   ...
   private:
	  ...
	  dtPhysics::PhysicsObject* mCornerPhysObj1;
	  dtPhysics::PhysicsObject* mCornerPhysObj2;
	  dtPhysics::PhysicsObject* mCornerPhysObj3;
	  dtPhysics::PhysicsObject* mCornerPhysObj4;
	  ...
	  bool bFloating;
	  //osg::Vec3 mCornerPos1;
	  //osg::Vec3 mCornerPos2;
	  //osg::Vec3 mCornerPos3;
	  //osg::Vec3 mCornerPos4;

	  // for testing
	  bool babiesMade;
	  PhysicsGenericActor* cornerBaby1;
	  PhysicsGenericActor* cornerBaby2;
	  PhysicsGenericActor* cornerBaby3;
	  PhysicsGenericActor* cornerBaby4;
 ...
 */
class VRS_PACIFPHYSICS_EXPORT ActorBoatProxy : public vrsCore::GameStaticMeshActorProxy
{
   public:
