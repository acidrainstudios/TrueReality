...
#ifndef VRSPACIFPHYSICS_DLL_EXPORT_H
#define VRSPACIFPHYSICS_DLL_EXPORT_H


#if defined(_MSC_VER) || defined(__CYGWIN__) || defined(__MINGW32__) || defined( __BCPLUSPLUS__)  || defined( __MWERKS__)
#  ifdef VRS_PACIFPHYSICS_LIBRARY
#    define VRS_PACIFPHYSICS_EXPORT __declspec(dllexport)
#  else
#    define VRS_PACIFPHYSICS_EXPORT __declspec(dllimport)
#  endif
#else
#  define VRS_PACIFPHYSICS_EXPORT
#endif


#endif //VRSPACIFPHYSICS_DLL_EXPORT_H