...
#include <trUtil/JSONArrayBase.h>
...
namespace trUtil
{
    class TR_UTIL_EXPORT JSArray : JSONArrayBase
    {
    public:
        /**
        * ctor
        ...
        */
        JSArray(const Json::Value &jsArray);
        ...
        */
        virtual JSArray GetArray(int &index) const;

        /**
        * Adds the Array to the Array
        */
        virtual void AddArray(JSArray &jsArray);
        ...
        */
        virtual JSObject GetObject(int &index) const;

        /**
        * Adds the Object to the Array
        */
        virtual void AddObject(JSObject &jsObject);
