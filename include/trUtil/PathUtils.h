...
namespace trUtil
{
    namespace PathUtils
    {
        ...
        /**
         * @fn  std::string GetSkeletalMeshesPath();
         *
         * @brief   Gets skeletal meshes path.
         *
         * @return  The skeletal meshes path.
         */
        ...
        /**
         * @fn  std::string GetParticlesPath();
         *
         * @brief   Gets particles path.
         *
        ...
        /**
         * @fn  std::string GetTerrainsPath();
         *
         * @brief   Gets terrain path.
         *
         * @return  The terrain path.
         */
        TR_UTIL_EXPORT std::string GetTerrainsPath();

        /**
         * @fn  std::string GetShadersPath();
         *
         * @brief   Gets shaders path.
         *
        ...
        /**
         * @fn  std::string GetGUIPath();
         *
         * @brief   Gets graphical user interface path.
         *
         * @return  The graphical user interface path.
         */
        ...
        /**
         * @fn  std::string GetUserStaticMeshesPath();
         *
         * @brief   Gets user static meshes path.
         *
         * @return  The user static meshes path.
         */
        ...
        /**
         * @fn  std::string GetUserTexturesPath();
         *
         * @brief   Gets user textures path.
         *
