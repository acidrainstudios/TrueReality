...
namespace trUtil
{
    ...
    */
    ...
    public:
        ...
        * @throws trUtil::FileNotFoundException if the source file is not found.
        * @throws trUtil::IOException if an error occurs copying the data or bOverwrite was false and the
        ...
        * @param bOverwrite true if this call should overwrite the destination file if it exists.
        * @throws trUtil::FileNotFoundException if the source file is not found.
        * @throws trUtil::IOException if an error occurs moving the data or bOverwrite was false and the
        *                                           destination file exists.
        */
        ...
        * @throws trUtil::IOException if an error occurs deleting the data
        */
        ...
        * @throws trUtil::FileNotFoundException if the path does not exist.
        */
        ...
        * @see popDirectory
        * @param path The path to the new directory.
        * @throws trUtil::FileNameFoundException if the path does not exist.
        */
        ...
        * @see pushDirectory
        * @throws trUtil::FileNotFoundException if the previous directory no longer exists.
        */
        void PopDirectory();
        ...
        * @throws trUtil::FileNotFoundException if the path does not exist.
        * @throws trUtil::IOException if the path is not an actual directory
        */
        ...
        * @throws trUtil::FileNotFoundException if the source file is not found.
        * @throws trUtil::IOException if an error occurs copying the data or bOverwrite was false and a
        *                                           destination file exists.
        */
        ...
        * @throws trUtil::FileNotFoundException if the path does not exist.
        * @throws trUtil::IOException if an error occurs deleteting the directory
        */
        ...
        * @param strDir the directory to create.
        * @throws trUtil::FileNotFoundException if the parent path does not exist.
        * @throws trUtil::IOException if an error occurs creating the directory
        */
