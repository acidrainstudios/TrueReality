...
namespace trUtil
{
    ...
    class TR_UTIL_EXPORT JSObject : JSONBase
    {
    public:
        /**
        * ctor
        ...
        */
        JSObject(const Json::Value &jsObject);
        ...
        */
        virtual JSArray GetArray(const std::string &key) const;

        /**
        * Sets the Array to be stored at the given key
        */
        virtual void SetArray(const std::string &key, JSArray &jsArray);
        ...
        */
        virtual JSObject GetObject(const std::string &key) const;

        /**
        * Sets the Array to be stored at the given key
        */
        virtual void SetObject(const std::string &key, JSObject &jsObject);
