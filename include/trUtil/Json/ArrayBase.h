...
namespace trUtil
{
    ...
    class TR_UTIL_EXPORT JSONArrayBase : osg::Referenced
    {
    ...
    public:
        ...
        */
        virtual JSArray GetArray(int &index) const = 0;

        /**
        * Adds the Array to the Array
        */
        virtual void AddArray(JSArray &jsArray) = 0;
        ...
        */
        virtual JSObject GetObject(int &index) const = 0;

        /**
        * Adds the Object to the Array
        */
        virtual void AddObject(JSObject &jsObject) = 0;
    };
}