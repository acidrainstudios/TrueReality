...
namespace trBase
{
    ...
    */
    ...
    public:
        ...
        */
        Vec3us(value_type x, value_type y, value_type z);

        /**
        * @brief   Copy Constructor from osg::Vec to trBase::Vec.
        *
        * @param   v   The osg::Vec3us to process.
        */
        Vec3us(const osg::Vec3us &v);

        /**
        * Returns the internal OSG vector.
        */
        const osg::Vec3us& GetOSGVector() const;
        ...
        */
        void Lerp(const Vec3us& to, value_type alpha);
        ...
        */
        Vec3us Lerp(const Vec3us& from, const Vec3us& to, value_type alpha);

        /**
         * @fn  std::string Vec3us::ToString(int precision = -1);
         *
        ...
        * Set operator
        */
        void operator = (const Vec3us& v);

        /**
        * Set operator
        */
        void operator = (const osg::Vec3us& v);
        ...
        */
        value_type operator * (const Vec3us& rhs) const;

        /**
        * Scalar multiplication operator.
        */
        const Vec3us operator * (value_type rhs) const;
        ...
        */
        const Vec3us operator + (const Vec3us& rhs) const;
        ...
        */
        ...
        /**
        * Negation operator. Returns the negative of the Vec3us.
        */
        const Vec3us operator - () const;
        ...
        * Implicit conversion operator to OSG Vector
        */
        operator const osg::Vec3us& () const;
