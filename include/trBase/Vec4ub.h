...
namespace trBase
{
    ...
    */
    ...
    public:
        ...
        *
        * @param   v   The osg::Vec4ub to process.
        */
        Vec4ub(const osg::Vec4ub &v);

        /**
        * Returns the internal OSG vector.
        */
        const osg::Vec4ub& GetOSGVector() const;
        ...
        */
        void Lerp(const Vec4ub& to, value_type alpha);
        ...
        */
        Vec4ub Lerp(const Vec4ub& from, const Vec4ub& to, value_type alpha);

        /**
         * @fn  std::string Vec4ub::ToString(int precision = -1);
         *
        ...
        * Set operator
        */
        void operator = (const Vec4ub& v);

        /**
        * Set operator
        */
        void operator = (const osg::Vec4ub& v);
        ...
        */
        value_type operator * (const Vec4ub& rhs) const;

        /**
        * Scalar multiplication operator.
        */
        const Vec4ub operator * (value_type rhs) const;

        /**
        * Unary scalar multiplication operator.
        */
        Vec4ub& operator *= (value_type rhs);
        ...
        */
        const Vec4ub operator + (const Vec4ub& rhs) const;
        ...
        */
        ...
        /**
        * Negation operator. Returns the negative of the Vec4ub.
        */
        const Vec4ub operator - () const;

        /**
        * Implicit conversion operator to OSG Vector
        */
        operator osg::Vec4ub() const;
        ...
        * Implicit conversion operator to OSG Vector
        */
        operator const osg::Vec4ub& () const;
