...
namespace trBase
{
    ...
    */
    ...
    public:
        ...
        *
        * @param   v   The osg::Vec4s to process.
        */
        Vec4s(const osg::Vec4s &v);

        /**
        * Returns the internal OSG vector.
        */
        const osg::Vec4s& GetOSGVector() const;
        ...
        */
        void Lerp(const Vec4s& to, value_type alpha);
        ...
        */
        Vec4s Lerp(const Vec4s& from, const Vec4s& to, value_type alpha);

        /**
         * @fn  std::string Vec4s::ToString(int precision = -1);
         *
        ...
        * Set operator
        */
        void operator = (const Vec4s& v);

        /**
        * Set operator
        */
        void operator = (const osg::Vec4s& v);
        ...
        */
        value_type operator * (const Vec4s& rhs) const;

        /**
        * Scalar multiplication operator.
        */
        const Vec4s operator * (value_type rhs) const;
        ...
        */
        const Vec4s operator + (const Vec4s& rhs) const;
        ...
        */
        const Vec4s operator - () const;

        /**
        * Implicit conversion operator to OSG Vector
        */
        operator osg::Vec4s() const;
        ...
        * Implicit conversion operator to OSG Vector
        */
        operator const osg::Vec4s& () const;
