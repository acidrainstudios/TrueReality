...
namespace trBase
{
    ...
    */
    ...
    public:
        ...
        *
        * @param   v   The osg::Vec4i to process.
        */
        Vec4i(const osg::Vec4i &v);

        /**
        * Returns the internal OSG vector.
        */
        const osg::Vec4i& GetOSGVector() const;
        ...
        */
        void Lerp(const Vec4i& to, value_type alpha);
        ...
        */
        Vec4i Lerp(const Vec4i& from, const Vec4i& to, value_type alpha);

        /**
         * @fn  std::string Vec4i::ToString(int precision = -1);
         *
        ...
        * Set operator
        */
        void operator = (const osg::Vec4i& v);
        ...
        */
        value_type operator * (const Vec4i& rhs) const;

        /**
        * Scalar multiplication operator.
        */
        const Vec4i operator * (value_type rhs) const;

        /**
        * Unary scalar multiplication operator.
        */
        Vec4i& operator *= (value_type rhs);
        ...
        */
        const Vec4i operator + (const Vec4i& rhs) const;
        ...
        * Implicit conversion operator to OSG Vector
        */
        operator const osg::Vec4i& () const;
