...
{
    /**
    * General purpose 2D byte Vector
    */
    class TR_BASE_EXPORT Vec2b
    {
    public:
        ...
        */
        Vec2b(value_type x, value_type y);
        ...
        */
        Vec2b(const osg::Vec2b &v);

        /**
        * Returns the internal OSG vector.
        */
        const osg::Vec2b& GetOSGVector() const;
        ...
        */
        void Lerp(const Vec2b& to, value_type alpha);
        ...
        */
        Vec2b Lerp(const Vec2b& from, const Vec2b& to, value_type alpha);

        /**
         * @fn  std::string Vec2b::ToString(int precision = -1);
         *
        ...
        * Set operator
        */
        void operator = (const Vec2b& v);

        /**
        * Set operator
        */
        void operator = (const osg::Vec2b& v);
        ...
        */
        value_type operator * (const Vec2b& rhs) const;

        /**
        * Scalar multiplication operator.
        */
        const Vec2b operator * (value_type rhs) const;

        /**
        * Unary scalar multiplication operator.
        */
        Vec2b& operator *= (value_type rhs);
        ...
        */
        const Vec2b operator + (const Vec2b& rhs) const;
        ...
        */
        const Vec2b operator - () const;

        /**
        * Implicit conversion operator to OSG Vector
        */
        operator osg::Vec2b() const;
        ...
        * Implicit conversion operator to OSG Vector
        */
        operator const osg::Vec2b& () const;
