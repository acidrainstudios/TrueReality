...
namespace trMPEG
{
     ...
     * @class   CodecH264
     *
     * @brief   A codec definition for encoding in raw H264 format.
     */
    class TR_MPEG_EXPORT CodecH264 : public CodecBase
    {
    public:
        ...
        /**
         * @fn  CodecH264::CodecH264(const std::string& name = CLASS_TYPE);
         *
