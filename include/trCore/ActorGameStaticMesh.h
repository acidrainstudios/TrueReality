...
namespace trCore
{
	...
	/*class TR_CORE_EXPORT GameStaticMeshActor : public dtActors::GameMeshActor
	{
	public:*/
 ...
 //       virtual void AddedToScene(dtCore::Scene* scene);
	 ...
	 */
	//class TR_CORE_EXPORT GameStaticMeshActorProxy : public dtActors::GameMeshActorProxy
	//{
	   //public:
