...
namespace trCore::Nodes
{
     ...
     * @author Maxim Serebrennik
     *
     * @brief   Class for wrapping the osg node Internally it contains an OSG Group, that can be
     *          accessed by user if additional functionality is required.
     */
    class TR_CORE_EXPORT Node : public trBase::Base
    {
    public:
