...
namespace trCore
{
     ...
     */
    class  TR_CORE_EXPORT MessageFrameSynch : public trManager::MessageTick
    {
    public:
        ...
        /**
         * @fn  MessageFrameSynch::MessageFrameSynch(const trBase::UniqueId* fromActorID, const trManager::TimingStructure& timeStruct);
         *
         * @brief   Constructor.
         *
         ...
         */
        MessageFrameSynch(const trBase::UniqueId* fromActorID, const trManager::TimingStructure& timeStruct);

        /**
         * @fn  virtual const std::string& MessageFrameSynch::GetMessageType() const override;
         *
    ...
    protected:
        ...
        /**
         * @fn  MessageFrameSynch::~MessageFrameSynch();
         *
         * @brief   Destructor.
         */
        ~MessageFrameSynch();
