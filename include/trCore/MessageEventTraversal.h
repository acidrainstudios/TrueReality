...
{
    /**
     * @class   MessageEventTraversal
     *
     * @brief   A message that is sent out on event traversal.
     */
    ...
    public:
        ...
        /**
         * @fn  MessageEventTraversal::MessageEventTraversal(const trBase::UniqueId* fromActorID, const trManager::TimingStructure& timeStruct);
         *
         * @brief   Constructor.
         *
         ...
         */
        MessageEventTraversal(const trBase::UniqueId* fromActorID, const trManager::TimingStructure& timeStruct);

        /**
         * @fn  virtual const std::string& MessageEventTraversal::GetMessageType() const override;
         *
    ...
    protected:
        ...
        /**
         * @fn  MessageEventTraversal::~MessageEventTraversal();
         *
         * @brief   Destructor.
         */
        ~MessageEventTraversal();
    };
}
