...
{
    /**
     * @class   MessagePostFrame
     *
     * @brief   A message that is sent out on Frame Event.
     */
    class  TR_CORE_EXPORT MessagePostFrame : public trManager::MessageTick
    {
    public:
        ...
        /**
         * @fn  MessagePostFrame::MessagePostFrame(const trBase::UniqueId* fromActorID, const trManager::TimingStructure& timeStruct);
         *
         * @brief   Constructor.
         *
         ...
         */
        MessagePostFrame(const trBase::UniqueId* fromActorID, const trManager::TimingStructure& timeStruct);

        /**
         * @fn  virtual const std::string& MessagePostFrame::GetMessageType() const override;
         *
    ...
    protected:
        ...
        /**
         * @fn  MessagePostFrame::~MessagePostFrame();
         *
         * @brief   Destructor.
         */
        ~MessagePostFrame();
